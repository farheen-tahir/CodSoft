        ...
        <form onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="form-control">
            ...
            <div className="colors">
              {colors.map((c, index) => {
                if(c==="all") {
                  return <button key={index} name="color" onClick={updateFilters} data-color="all" className={`${
          ...
          <div className="form-control">
            ...
            <input type="range" name="price" id="" min={min_price} max={max_price} value={price} onChange={updateFilters} />
          </div>
